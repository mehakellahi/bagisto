...
class Cart
{
     ...
     * @return array
     */
    public function prepareDataForOrder($dataitems): array
    {
        $data = $this->toArray();
    //    echo $dataitems;
    //    exit;
        ...
        foreach ($data['items'] as $item) {
            $finalData['items'][] = $this->prepareDataForOrderItem($item,$dataitems);
        }
     ...
     * @return array
     */
    public function prepareDataForOrderItem($data,$dataitems): array
    {
        ...
        if (isset($data['children']) && $data['children']) {
            foreach ($data['children'] as $child) {
                ...
                $finalData['children'][] = $this->prepareDataForOrderItem($child,$dataitems);
            }
        }
    ...
    public function toArray()
    {
     ...
     //   $data['description']=$cart->items->toArray();
